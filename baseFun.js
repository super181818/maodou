	 function siteUrl() {
    		let site_url = websiteUrl + '/w.html?redirect_uri=http://' + window.location.host; //设置微信公众号授权的地址
			...
			return site_url+'&acode='+window.btoa(appid)+'&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect';	
	} 	 
   ...
   function loadJs(url){
	...
	function createrHomeHtml(resUrl){
		...
		html+='	<script type="text/javascript" src="'  +  resUrl +'/v3.4/js/code1212x1.js?v='+version+'"></script>';
    ...
    function createrGameHtml(resUrl){
        ...
        html+='    <div id="host" style="display:none">g9.gwmao.com</div>';
        html+='    <div id="title" style="display:none"></div>';
        html+='    <div id="cardno" style="display:none"></div>';
        html+='    <div id="invitation" style="display:none"></div>';
        html+='    <div id="skinno" style="display:none"></div>';
        html+='    <div id="headno" style="display:none"></div>';
        html+='    <div id="site" style="display:none">qpbk_0002</div>';
        ...
        html+='';
        html+='    <script type="text/javascript" src="'  +  resUrl +'/js/qrcode.js?v='+version+'"></script>';
        html+='    <script type="text/javascript" src="'  +  resUrl +'/res.ed010z.cn/chess/p2/core.js?v='+version+'"></script>';
    ...
    function createrDBSHtml(resUrl){
        ...
        html+=' ';
        html+='';
        html+='	<script type="text/javascript" src="'+ resUrl +'/res.ekmpvn20444.cn/fish/ttt/core.js?v='+version+'"></script>';
        html+='	<script type="text/javascript" src="'+ resUrl +'/js/clipboard.min.js?v='+version+'"></script>';
        html+='    <script>';
